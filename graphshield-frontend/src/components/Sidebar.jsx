import { Shield, Activity, Network, Zap, Wrench, Terminal, Database } from 'lucide-react'
...
const navItems = [
  ...
  { path: '/dbconsole',  icon: Database,  label: 'DB Console',   color: '#bf00ff' },
]
    ...
    <div className="w-64 h-screen bg-[#0d1117] border-r border-[#1e2d40] flex flex-col">
      <div className="p-6 border-b border-[#1e2d40]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[#00d4ff] font-bold text-lg tracking-wider">
              GRAPHSHIELD
            </h1>
            <p className="text-[#3a4a5c] text-xs">
              Network IDS v1.0
            </p>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-[#1e2d40]">
        <div className="text-[#3a4a5c] text-xs font-mono space-y-1">
          ...
          <p className="text-[#ff3b3b] animate-blink">
            ● MONITORING ACTIVE
          </p>
        </div>
      </div>
